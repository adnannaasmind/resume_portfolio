...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.E:\laragon\www\resume_portfolio\public\storage' => 'string',
            ...
            'services.stripe.public_key' => 'NULL',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.E:\\laragon\\www\\resume_portfolio\\public\\storage','logging.default',
...
'services.slack.notifications.bot_user_oauth_token','services.slack.notifications.channel','services.stripe.public_key','services.stripe.secret_key','services.stripe.webhook_secret',
'services.paypal.client_id','services.paypal.client_secret','services.paypal.environment','services.paypal.webhook_id','services.openai.key',
'services.openai.model','services.watermark.text','session.driver','session.lifetime','session.expire_on_close',
...
'sanctum.csrf-cookie','share.resume',
'resumes.index','resumes.store','resumes.show','resumes.update','resumes.destroy',
'portfolios.index','portfolios.store','portfolios.show','portfolios.update','portfolios.destroy','home','dashboard','pricing',
'templates.index','portfolio.public','resume.share','profile.edit','profile.update',
'profile.destroy','resumes.index','resumes.create','resumes.store','resumes.show',
'resumes.edit','resumes.update','resumes.destroy','resumes.duplicate','resumes.publish',
'resumes.unpublish','resumes.export','portfolios.index','portfolios.create','portfolios.store',
'portfolios.show','portfolios.edit','portfolios.update','portfolios.destroy','portfolios.publish',
'portfolios.unpublish','pricing.checkout','register','login','password.request','password.email','password.reset','password.store',
'verification.notice','verification.verify','verification.send','password.confirm',
'password.update','logout','admin.login','admin.login.submit','admin.logout',
'admin.dashboard','admin.users.index','admin.users.show','admin.users.edit','admin.resumes.index',
'admin.resumes.show','admin.templates.index','admin.templates.create','admin.templates.edit','admin.plans.index',
'admin.plans.create','admin.plans.edit','admin.portfolio-templates.index','admin.portfolio-templates.create','admin.portfolio-templates.edit',
'admin.reports.payments','admin.reports.users','admin.settings.system','admin.settings.smtp','admin.settings.payment',
'admin.settings.website','admin.settings.languages','admin.settings.seo','admin.settings.about','admin.profile',
'api.admin.dashboard.stats','api.admin.templates.index','api.admin.templates.store','api.admin.templates.show','api.admin.templates.update',
'api.admin.templates.destroy','api.admin.plans.index','api.admin.plans.store','api.admin.plans.show','api.admin.plans.update',
'api.admin.plans.destroy','api.admin.users.index','api.admin.users.show','api.admin.users.update','api.admin.settings.index',
'api.admin.settings.update','storage.local',);
        registerArgumentsSet('views', 
'admin.auth.login','admin.dashboard','admin.layouts.footer','admin.layouts.master','admin.layouts.navbar',
'admin.layouts.sidebar','admin.plans.create','admin.plans.edit','admin.plans.index','admin.portfolio-templates.create',
'admin.portfolio-templates.edit','admin.portfolio-templates.index','admin.profile','admin.reports.payments','admin.reports.users',
'admin.resumes.index','admin.resumes.show','admin.settings.about','admin.settings.index','admin.settings.languages',
'admin.settings.payment','admin.settings.seo','admin.settings.smtp','admin.settings.system','admin.settings.website',
'admin.templates.create','admin.templates.edit','admin.templates.index','admin.users.edit','admin.users.index',
'admin.users.show','auth.confirm-password','auth.forgot-password','auth.login','auth.register',
...
'frontend.dashboard.dashboard','frontend.dashboard.layouts.master','frontend.dashboard.layouts.sidebar','frontend.home.home','frontend.layouts.app',
'frontend.layouts.app-lite','frontend.layouts.footer','frontend.layouts.guest','frontend.layouts.header_menu','frontend.layouts.master',
'frontend.layouts.navigation','frontend.pages.portfolios.create','frontend.pages.portfolios.edit','frontend.pages.portfolios.index','frontend.pages.pricing.index',
'frontend.pages.profile.edit','frontend.pages.profile.partials.delete-user-form','frontend.pages.profile.partials.update-password-form','frontend.pages.profile.partials.update-profile-information-form','frontend.pages.resumes.create',
'frontend.pages.resumes.edit','frontend.pages.resumes.index','frontend.pages.resumes.pdf','frontend.pages.share.portfolio','frontend.pages.share.resume',
'frontend.pages.templates.index','welcome','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state','laravel-exceptions-renderer::components.file-with-line',
...
'E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.failed','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.password','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.throttle','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.previous','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.next',
'E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.reset','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.sent','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.throttled','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.token','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.user',
'E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted_if','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.active_url','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after_or_equal',
'E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_dash','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_num','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.any_of','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array',
'E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ascii','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before_or_equal','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.array','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.file',
'E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.numeric','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.string','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.boolean','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.can','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.confirmed',
'E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.contains','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.current_password','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_equals','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_format',
'E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.decimal','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined_if','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.different','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits',
'E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits_between','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.dimensions','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.distinct','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_contain','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_end_with',
'E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_start_with','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.email','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.encoding','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ends_with','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.enum',
'E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.exists','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.extensions','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.file','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.filled','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.array',
'E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.file','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.numeric','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.string','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.array','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.file',
'E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.numeric','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.string','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.hex_color','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.image','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in',
'E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array_keys','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.integer','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ip','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv4',
'E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv6','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.json','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.list','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lowercase','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.array',
'E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.file','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.numeric','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.string','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.array','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.file',
'E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.numeric','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.string','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mac_address','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.array','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.file',
'E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.numeric','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.string','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max_digits','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimes','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimetypes',
'E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.array','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.file','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.numeric','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.string','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min_digits',
'E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_if','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_unless','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with_all',
'E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.multiple_of','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_in','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_regex','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.numeric','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.letters',
'E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.mixed','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.numbers','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.symbols','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.uncompromised','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present',
'E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_if','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_unless','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with_all','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited',
'E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_accepted','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_declined','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_unless','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibits',
'E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.regex','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_array_keys','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_accepted',
'E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_declined','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_unless','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with_all','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without',
'E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without_all','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.same','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.array','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.file','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.numeric',
'E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.string','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.starts_with','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.string','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.timezone','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.unique',
'E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uploaded','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uppercase','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.url','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ulid','E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid',
'E:.laragon.www.resume_portfolio.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);
