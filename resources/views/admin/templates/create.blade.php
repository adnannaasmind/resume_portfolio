...
<div class="page-inner">
    <div class="page-header">
        <h3 class="fw-bold mb-3">Create Resume Template</h3>
                    ...
                    <form action="{{ route('admin.templates.store') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control @error('category') is-invalid @enderror"
                                ...
                                <option value="modern" {{ old('category') == 'modern' ? 'selected' : '' }}>{{ __('Modern') }}</option>
                                <option value="classic" {{ old('category') == 'classic' ? 'selected' : '' }}>{{ __('Classic') }}</option>
                                <option value="creative" {{ old('category') == 'creative' ? 'selected' : '' }}>{{ __('Creative') }}</option>
                                <option value="professional" {{ old('category') == 'professional' ? 'selected' : '' }}>{{ __('Professional') }}</option>
                            </select>
                            @error('category')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
