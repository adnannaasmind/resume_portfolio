    ...
    <div
        ...
        <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
            <div
                ...
                <h1 class="mb-4 text-2xl font-bold text-[#1b1b18] dark:text-[#EDEDEC]">Build Your Professional Resume
                </h1>
                <p class="mb-6 text-[#706f6c] dark:text-[#A1A09A] leading-relaxed">Create stunning resumes and
                    portfolios with our AI-powered platform. Choose from premium templates, export to PDF, and share
                    with a click.</p>
                <ul class="flex flex-col mb-6 lg:mb-8 space-y-3">
                    <li class="flex items-center gap-3">
                        <svg class="w-5 h-5 text-[#f53003] dark:text-[#FF4433] flex-shrink-0" fill="none"
                            stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                        </svg>
                        <span class="text-[#1b1b18] dark:text-[#EDEDEC]">8-10 professional templates</span>
                    </li>
                    <li class="flex items-center gap-3">
                        <svg class="w-5 h-5 text-[#f53003] dark:text-[#FF4433] flex-shrink-0" fill="none"
                            stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <span class="text-[#1b1b18] dark:text-[#EDEDEC]">AI-powered cover letters</span>
                    </li>
                    <li class="flex items-center gap-3">
                        <svg class="w-5 h-5 text-[#f53003] dark:text-[#FF4433] flex-shrink-0" fill="none"
                            stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <span class="text-[#1b1b18] dark:text-[#EDEDEC]">PDF export & sharing</span>
                    </li>
                    <li class="flex items-center gap-3">
                        <svg class="w-5 h-5 text-[#f53003] dark:text-[#FF4433] flex-shrink-0" fill="none"
                            stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <span class="text-[#1b1b18] dark:text-[#EDEDEC]">Portfolio builder</span>
                    </li>
                </ul>
                <div class="flex gap-3 text-sm leading-normal">
                    @guest
                        <a href="{{ route('register') }}"
                            class="inline-flex items-center px-6 py-2.5 bg-[#1b1b18] dark:bg-[#eeeeec] border border-black dark:border-[#eeeeec] text-white dark:text-[#1C1C1A] rounded-lg hover:bg-black dark:hover:bg-white font-medium transition-colors">
                            Get Started Free
                        </a>
                        <a href="{{ route('pricing') }}"
                            class="inline-flex items-center px-6 py-2.5 border border-[#19140035] dark:border-[#3E3E3A] text-[#1b1b18] dark:text-[#EDEDEC] rounded-lg hover:border-[#1915014a] dark:hover:border-[#62605b] font-medium transition-colors">
                            View Pricing
                        </a>
                    @else
