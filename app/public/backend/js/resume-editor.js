        ...
        const formHtml = `
            <form id="experienceForm" class="edit-form">
                <div class="edit-form-group">
                    ...
                    <input type="text" name="title" class="edit-form-input" placeholder="e.g., Senior Software Engineer" required>
                </div>
                <div class="edit-form-group">
                    <label class="edit-form-label">Company *</label>
                    <input type="text" name="company" class="edit-form-input" placeholder="e.g., Google Inc." required>
                </div>
                <div class="edit-form-group">
                    <label class="edit-form-label">Location</label>
                    <input type="text" name="location" class="edit-form-input" placeholder="e.g., New York, USA">
                </div>
                <div class="edit-form-group">
                    <label class="edit-form-label">Start Date *</label>
                    <input type="date" name="start_date" class="edit-form-input" placeholder="Select start date" required>
                </div>
                <div class="edit-form-group">
                    <label class="edit-form-label">End Date</label>
                    <input type="date" name="end_date" class="edit-form-input" placeholder="Select end date">
                </div>
                <div class="edit-form-group">
    ...
    editExperience(experienceId) {
        ...
        const formHtml = `
            <form id="experienceForm" class="edit-form">
                ...
                <div class="edit-form-group">
                    <label class="edit-form-label">Job Title *</label>
                    <input type="text" name="title" class="edit-form-input" value="${experience.title}" placeholder="e.g., Senior Software Engineer" required>
                </div>
                <div class="edit-form-group">
                    <label class="edit-form-label">Company *</label>
                    <input type="text" name="company" class="edit-form-input" value="${experience.company}" placeholder="e.g., Google Inc." required>
                </div>
                <div class="edit-form-group">
                    <label class="edit-form-label">Location</label>
                    <input type="text" name="location" class="edit-form-input" value="${experience.location}" placeholder="e.g., New York, USA">
                </div>
                <div class="edit-form-group">
                    <label class="edit-form-label">Start Date *</label>
                    <input type="date" name="start_date" class="edit-form-input" value="${experience.start_date}" placeholder="Select start date" required>
                </div>
                <div class="edit-form-group">
                    <label class="edit-form-label">End Date</label>
                    <input type="date" name="end_date" class="edit-form-input" value="${experience.end_date}" placeholder="Select end date" ${experience.is_current ? 'disabled' : ''}>
                </div>
                <div class="edit-form-group">
                    <label class="edit-form-checkbox">
        ...
        const formHtml = `
            <form id="educationForm" class="edit-form">
                <div class="edit-form-group">
                    ...
                    <input type="text" name="degree" class="edit-form-input" placeholder="e.g., Bachelor of Science in Computer Science" required>
                </div>
                <div class="edit-form-group">
                    <label class="edit-form-label">Institution *</label>
                    <input type="text" name="institution" class="edit-form-input" placeholder="e.g., Harvard University" required>
                </div>
                <div class="edit-form-group">
                    <label class="edit-form-label">Start Date *</label>
                    <input type="date" name="start_date" class="edit-form-input" placeholder="Select start date" required>
                ...
                <div class="edit-form-group">
                    <label class="edit-form-label">End Date</label>
                    <input type="date" name="end_date" class="edit-form-input" placeholder="Select end date or leave empty if ongoing">
                </div>
                <div class="edit-form-group">
                    <label class="edit-form-label">Description</label>
                    <textarea name="description" class="edit-form-textarea" placeholder="e.g., Major in Computer Science, GPA: 3.8/4.0, Dean's List" rows="4"></textarea>
                </div>
                <div class="edit-form-actions">
    ...
    editEducation(educationId) {
        ...
        const formHtml = `
            <form id="educationForm" class="edit-form">
                ...
                <div class="edit-form-group">
                    <label class="edit-form-label">Degree/Certificate *</label>
                    <input type="text" name="degree" class="edit-form-input" value="${education.degree}" placeholder="e.g., Bachelor of Science in Computer Science" required>
                </div>
                <div class="edit-form-group">
                    <label class="edit-form-label">Institution *</label>
                    <input type="text" name="institution" class="edit-form-input" value="${education.institution}" placeholder="e.g., Harvard University" required>
                </div>
                <div class="edit-form-group">
                    <label class="edit-form-label">Start Date *</label>
                    <input type="date" name="start_date" class="edit-form-input" value="${education.start_date}" placeholder="Select start date" required>
                </div>
                <div class="edit-form-group">
                    <label class="edit-form-label">End Date</label>
                    <input type="date" name="end_date" class="edit-form-input" value="${education.end_date}" placeholder="Select end date or leave empty if ongoing">
                </div>
                <div class="edit-form-group">
                    <label class="edit-form-label">Description</label>
                    <textarea name="description" class="edit-form-textarea" placeholder="e.g., Major in Computer Science, GPA: 3.8/4.0, Dean's List" rows="4">${education.description}</textarea>
                </div>
                <div class="edit-form-actions">
        ...
        const formHtml = `
            <form id="skillForm" class="edit-form">
                <div class="edit-form-group">
                    ...
                    <input type="text" name="name" class="edit-form-input" placeholder="e.g., JavaScript, Python, React, Communication" required>
                </div>
                <div class="edit-form-group">
    ...
    editSkill(skillId) {
        ...
        const formHtml = `
            <form id="skillForm" class="edit-form">
                ...
                <div class="edit-form-group">
                    <label class="edit-form-label">Skill Name *</label>
                    <input type="text" name="name" class="edit-form-input" value="${skill.name}" placeholder="e.g., JavaScript, Python, React, Communication" required>
                </div>
                <div class="edit-form-group">
                    <label class="edit-form-label">Proficiency Level</label>
                    <select name="level" class="edit-form-select">
        ...
        const formHtml = `
            <form id="projectForm" class="edit-form">
                <div class="edit-form-group">
                    ...
                    <input type="text" name="name" class="edit-form-input" placeholder="e.g., E-Commerce Platform, Mobile App" required>
                </div>
                <div class="edit-form-group">
                    <label class="edit-form-label">URL</label>
                    <input type="url" name="url" class="edit-form-input" placeholder="e.g., https://github.com/username/project">
                </div>
                <div class="edit-form-group">
                    <label class="edit-form-label">Your Role</label>
                    <input type="text" name="role" class="edit-form-input" placeholder="e.g., Lead Developer, Team Member">
                </div>
                <div class="edit-form-group">
                    <label class="edit-form-label">Description</label>
                    <textarea name="description" class="edit-form-textarea" placeholder="Brief description of the project and your contributions" rows="5"></textarea>
                </div>
                <div class="edit-form-actions">
    ...
    editProject(projectId) {
        ...
        const formHtml = `
            <form id="projectForm" class="edit-form">
                ...
                <div class="edit-form-group">
                    <label class="edit-form-label">Project Name *</label>
                    <input type="text" name="name" class="edit-form-input" value="${project.name}" placeholder="e.g., E-Commerce Platform, Mobile App" required>
                </div>
                <div class="edit-form-group">
                    <label class="edit-form-label">URL</label>
                    <input type="url" name="url" class="edit-form-input" value="${project.url}" placeholder="e.g., https://github.com/username/project">
                </div>
                <div class="edit-form-group">
                    <label class="edit-form-label">Your Role</label>
                    <input type="text" name="role" class="edit-form-input" value="${project.role}" placeholder="e.g., Lead Developer, Team Member">
                </div>
                <div class="edit-form-group">
                    <label class="edit-form-label">Description</label>
                    <textarea name="description" class="edit-form-textarea" placeholder="Brief description of the project and your contributions" rows="5">${project.description}</textarea>
                </div>
                <div class="edit-form-actions">
        ...
        const formHtml = `
            <form id="profileForm" class="edit-form" enctype="multipart/form-data">
                ...
                <div class="edit-form-group">
                    ...
                    <input type="text" name="name" class="edit-form-input" value="${profile.name}" placeholder="e.g., John Doe" required>
                </div>
                <div class="edit-form-group">
                    <label class="edit-form-label">Job Title *</label>
                    <input type="text" name="job_title" class="edit-form-input" value="${profile.job_title}" placeholder="e.g., Senior Software Engineer" required>
                </div>
                <div class="edit-form-actions">
        ...
        const formHtml = `
            <form id="contactForm" class="edit-form">
                <div class="edit-form-group">
                    ...
                    <input type="email" name="email" class="edit-form-input" value="${contact.email}" placeholder="e.g., john.doe@email.com" required>
                </div>
                <div class="edit-form-group">
                    <label class="edit-form-label">Phone</label>
                    <input type="tel" name="phone" class="edit-form-input" value="${contact.phone}" placeholder="e.g., +1 (555) 123-4567">
                </div>
                <div class="edit-form-group">
                    <label class="edit-form-label">Website</label>
                    <input type="url" name="website" class="edit-form-input" value="${contact.website}" placeholder="e.g., https://johndoe.com">
                </div>
                <div class="edit-form-group">
                    <label class="edit-form-label">Location</label>
                    <input type="text" name="location" class="edit-form-input" value="${contact.location}" placeholder="e.g., New York, USA">
                </div>
                <div class="edit-form-group">
                    <label class="edit-form-label">LinkedIn URL</label>
                    <input type="url" name="linkedin" class="edit-form-input" value="${contact.linkedin}" placeholder="e.g., https://linkedin.com/in/johndoe">
                </div>
                <div class="edit-form-group">
                    <label class="edit-form-label">GitHub URL</label>
                    <input type="url" name="github" class="edit-form-input" value="${contact.github}" placeholder="e.g., https://github.com/johndoe">
                </div>
                <div class="edit-form-actions">
        ...
        const formHtml = `
            <form id="aboutForm" class="edit-form">
                <div class="edit-form-group">
                    ...
                    <textarea name="summary" class="edit-form-textarea" placeholder="Write a brief summary about yourself, your skills, and career objectives..." rows="8" required>${about.summary}</textarea>
        ...
        const formHtml = `
            <form id="referenceForm" class="edit-form">
                <div class="edit-form-group">
                    ...
                    <input type="text" name="name" class="edit-form-input" placeholder="e.g., Jane Smith" required>
                </div>
                <div class="edit-form-group">
                    <label class="edit-form-label">Position/Title *</label>
                    <input type="text" name="position" class="edit-form-input" placeholder="e.g., Senior Manager, Director" required>
                </div>
                <div class="edit-form-group">
                    <label class="edit-form-label">Company</label>
                    <input type="text" name="company" class="edit-form-input" placeholder="e.g., ABC Corporation">
                </div>
                <div class="edit-form-group">
                    <label class="edit-form-label">Phone</label>
                    <input type="tel" name="phone" class="edit-form-input" placeholder="e.g., +1 (555) 987-6543">
                </div>
                <div class="edit-form-group">
                    <label class="edit-form-label">Email</label>
                    <input type="email" name="email" class="edit-form-input" placeholder="e.g., jane.smith@company.com">
                </div>
                <div class="edit-form-actions">
    ...
    editReference(referenceId) {
        ...
        const formHtml = `
            <form id="referenceForm" class="edit-form">
                ...
                <div class="edit-form-group">
                    <label class="edit-form-label">Reference Name *</label>
                    <input type="text" name="name" class="edit-form-input" value="${reference.name}" placeholder="e.g., Jane Smith" required>
                </div>
                <div class="edit-form-group">
                    <label class="edit-form-label">Position/Title *</label>
                    <input type="text" name="position" class="edit-form-input" value="${reference.position}" placeholder="e.g., Senior Manager, Director" required>
                </div>
                <div class="edit-form-group">
                    <label class="edit-form-label">Company</label>
                    <input type="text" name="company" class="edit-form-input" value="${reference.company}" placeholder="e.g., ABC Corporation">
                </div>
                <div class="edit-form-group">
                    <label class="edit-form-label">Phone</label>
                    <input type="tel" name="phone" class="edit-form-input" value="${reference.phone}" placeholder="e.g., +1 (555) 987-6543">
                </div>
                <div class="edit-form-group">
                    <label class="edit-form-label">Email</label>
                    <input type="email" name="email" class="edit-form-input" value="${reference.email}" placeholder="e.g., jane.smith@company.com">
                </div>
                <div class="edit-form-actions">
        ...
        const formHtml = `
            <form id="achievementForm" class="edit-form">
                <div class="edit-form-group">
                    ...
                    <input type="text" name="title" class="edit-form-input" placeholder="e.g., Employee of the Year, Best Project Award" required>
                </div>
                <div class="edit-form-group">
                    <label class="edit-form-label">Issuer/Organization</label>
                    <input type="text" name="issuer" class="edit-form-input" placeholder="e.g., Company Name or Organization">
                </div>
                <div class="edit-form-group">
                    <label class="edit-form-label">Date</label>
                    <input type="date" name="date" class="edit-form-input" placeholder="Select date">
                </div>
                <div class="edit-form-group">
                    <label class="edit-form-label">Description</label>
                    <textarea name="description" class="edit-form-textarea" placeholder="Describe your achievement and its impact" rows="4"></textarea>
                </div>
                <div class="edit-form-actions">
    ...
    editAchievement(achievementId) {
        ...
        const formHtml = `
            <form id="achievementForm" class="edit-form">
                <div class="edit-form-group">
                    <label class="edit-form-label">Title *</label>
                    <input type="text" name="title" class="edit-form-input" value="${title}" placeholder="e.g., Employee of the Year, Best Project Award" required>
                </div>
                <div class="edit-form-group">
                    <label class="edit-form-label">Issuer/Organization</label>
                    <input type="text" name="issuer" class="edit-form-input" value="${issuer}" placeholder="e.g., Company Name or Organization">
                </div>
                <div class="edit-form-group">
                    <label class="edit-form-label">Date</label>
                    <input type="date" name="date" class="edit-form-input" value="${date}" placeholder="Select date">
                </div>
                <div class="edit-form-group">
                    <label class="edit-form-label">Description</label>
                    <textarea name="description" class="edit-form-textarea" placeholder="Describe your achievement and its impact" rows="4">${description}</textarea>
                </div>
                <div class="edit-form-actions">
    ...
    editPassion(passionId) {
        ...
        const formHtml = `
            <form id="passionForm" class="edit-form">
                <div class="edit-form-group">
                    <label class="edit-form-label">Title *</label>
                    <input type="text" name="title" class="edit-form-input" value="${title}" placeholder="e.g., Music, Travel, Photography" required>
                </div>
                <div class="edit-form-group">
                    <label class="edit-form-label">Description</label>
                    <textarea name="description" class="edit-form-textarea" placeholder="Briefly describe your passion or interest" rows="3">${description}</textarea>
                </div>
                <div class="edit-form-actions">
