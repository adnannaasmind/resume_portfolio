    ...
    <div class="container" data-resume-id="{{ $resume->id }}">
        ...
        <div class="sidebar_template_free">
            ...
            <div class="profile-img" style="position: relative;">
                ...
                @if ($isEditMode ?? false)
                    <div class="profile-img-edit" onclick="resumeEditor.editProfile()"
                        title="Edit Profile (Image, Name, Title)">
            ...
            <div class="name" style="position: relative; cursor: {{ ($isEditMode ?? false) ? 'pointer' : 'default' }};"
                @if($isEditMode ?? false) onclick="resumeEditor.editProfile()" title="Click to edit profile" @endif>
            ...
            <div class="section">
                ...
                @if(isset($resume->user->userProfile->website) && $resume->user->userProfile->website)
                    <div class="contact-item">
                        <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9a9 9 0 01-9-9m9 9c1.657 0 3-4.03 3-9s-1.343-9-3-9m0 18c-1.657 0-3-4.03-3-9s1.343-9 3-9m-9 9a9 9 0 019-9" />
                        </svg>
                        <a href="{{ $resume->user->userProfile->website }}" target="_blank"
                            style="color: inherit; text-decoration: none;"
                            data-contact-website="{{ $resume->user->userProfile->website }}">{{ $resume->user->userProfile->website }}</a>
                    </div>
                @endif
                @if(isset($resume->user->userProfile->linkedin_url) && $resume->user->userProfile->linkedin_url)
                    <div class="contact-item">
                        <svg fill="currentColor" viewBox="0 0 24 24">
                            <path
                                d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" />
                        </svg>
                        <a href="{{ $resume->user->userProfile->linkedin_url }}" target="_blank"
                            style="color: inherit; text-decoration: none;"
                            data-contact-linkedin="{{ $resume->user->userProfile->linkedin_url }}">LinkedIn</a>
                    </div>
                @endif
                @if(isset($resume->user->userProfile->github_url) && $resume->user->userProfile->github_url)
                    <div class="contact-item">
                        <svg fill="currentColor" viewBox="0 0 24 24">
                            <path
                        ...
                        <a href="{{ $resume->user->userProfile->github_url }}" target="_blank"
                            style="color: inherit; text-decoration: none;"
                            data-contact-github="{{ $resume->user->userProfile->github_url }}">GitHub</a>
                    </div>
                @endif
            </div>
                        ...
                        <div class="item-header">
                            <div>
                                ...
                                <div class="item-subtitle">
                                    {{ $experience->company }}@if(isset($experience->location) && $experience->location) -
